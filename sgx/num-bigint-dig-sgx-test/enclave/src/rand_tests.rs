...
pub mod biguint {
    ...
    ////#[test]
    //pub fn test_chacha_value_stability() {
    ...
    //#[test]
    pub fn test_isaac_value_stability() {
    ...
    //#[test]
    pub fn test_xorshift_value_stability() {
